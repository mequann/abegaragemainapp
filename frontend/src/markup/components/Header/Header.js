            ...
            <div className="auto-container">
                <div className="inner-container">
                    ...
                    <div className="right-column">
                        ...
                        <div className="link-btn"><a href="/login" className="theme-btn btn-style-one">lonin </a></div>
                    </div>                        
                </div>
            </div>
        </div>
                ...
                <div className="auto-container">
                    <div className="inner-container">
                        ...
                        <div className="right-column">
                            ...
                            <div className="search-btn"></div>
                            <div className="link-btn"><a href="#" className="theme-btn btn-style-one">lonin </a></div>
                        </div>                        
                    </div>
                </div>
            </div>
